...
// Event is an event potentially triggered by the BVM's LOG mechanism. The Event
...
func (e Event) ShortString() string {
	...
	return fmt.Sprintf("%v(%v)", e.RawName, strings.Join(inputs, ", "))
}
...
func (e Event) ID() Hash {
	return BytesToHash(ecrypto.Keccak256([]byte(e.Sig())))
}
