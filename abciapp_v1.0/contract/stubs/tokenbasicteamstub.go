...
import (
	...
	tb_t "github.com/bcbchain/bcbchain/abciapp_v1.0/contract/tokenbasic_team"
...
func (tbc *TBTStub) Dispatcher(items *stubapi.InvokeParams) (response stubapi.Response, bcerr bcerrors.BCError) {
