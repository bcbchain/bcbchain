...
import (
	...
	"github.com/bcbchain/bcbchain/abciapp_v1.0/contract/transferAgency"
	. "github.com/bcbchain/bclib/bignumber_v1.0"

	"github.com/bcbchain/bcbchain/abciapp_v1.0/smc"
	"github.com/bcbchain/sdk/sdk/rlp"
	//"github.com/bcbchain/bcbchain/abciapp_v1.0/contract/incentive"
...
func (tac *TACStub) Dispatcher(items *stubapi.InvokeParams) (response stubapi.Response, bcerr bcerrors.BCError) {
