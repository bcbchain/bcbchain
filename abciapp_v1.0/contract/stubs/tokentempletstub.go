...
import (
	...
	tokencontract "github.com/bcbchain/bcbchain/abciapp_v1.0/contract/tokentemplet"
...
func (tbs *TokenTempletStub) Dispatcher(items *stubapi.InvokeParams) (response stubapi.Response, bcerr bcerrors.BCError) {
