...
import (
	...
	"github.com/bcbchain/bcbchain/abciapp_v1.0/contract/system"
...
func (smcs *SystemStub) Dispatcher(items *stubapi.InvokeParams) (response stubapi.Response, bcerr bcerrors.BCError) {
	...
	case smcs.SmcMethods[SMC_METHODID_DEPLOYINTNCONTRACT].MethodID:
		...
		case prototype.MINING:
			response.Code = stubapi.RESPONSE_CODE_NEWMININGCONTRACT
		}
