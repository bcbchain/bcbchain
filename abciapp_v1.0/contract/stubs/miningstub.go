...
import (
	...
	"github.com/bcbchain/bcbchain/abciapp_v1.0/contract/mining"
...
func (mns *MNStub) Dispatcher(items *stubapi.InvokeParams) (response stubapi.Response, bcerr bcerrors.BCError) {
