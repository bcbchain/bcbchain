...
import (
	...
	base "github.com/bcbchain/bcbchain/abciapp_v1.0/contract/tokenbasic"
...
func (tbs *TokenBasicStub) Dispatcher(items *stubapi.InvokeParams) (response stubapi.Response, bcerr bcerrors.BCError) {
