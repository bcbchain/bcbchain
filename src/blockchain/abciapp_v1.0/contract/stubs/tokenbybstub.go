...
import (
	...
	"blockchain/abciapp_v1.0/contract/tokenbyb"
...
func (bybs *TokenBYBStub) Dispatcher(items *stubapi.InvokeParams, transID int64) (response stubapi.Response, bcerr bcerrors.BCError) {
