...
import (
	...
	tb_f "blockchain/abciapp_v1.0/contract/tokenbasic_foundation"
...
func (tbc *TBFStub) Dispatcher(items *stubapi.InvokeParams, transID int64) (response stubapi.Response, bcerr bcerrors.BCError) {
