...
import (
	...
	upgrade1to22 "blockchain/abciapp_v1.0/contract/upgrade1to2"
...
func (u *Upgrade1to2Stub) Dispatcher(items *stubapi.InvokeParams, transID int64) (response stubapi.Response, bcerr bcerrors.BCError) {
