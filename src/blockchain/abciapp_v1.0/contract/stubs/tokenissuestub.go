...
import (
	...
	cntr "blockchain/abciapp_v1.0/contract/tokenissue"
...
func (tbs *TokenIssueStub) Dispatcher(items *stubapi.InvokeParams, transID int64) (response stubapi.Response, bcerr bcerrors.BCError) {
