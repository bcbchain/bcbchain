...
import (
	tb_c "blockchain/abciapp_v1.0/contract/tokenbasic_cancellation"
	"encoding/json"
	"fmt"
	"strconv"
...
func (tbc *TBCStub) Dispatcher(items *stubapi.InvokeParams, transID int64) (response stubapi.Response, bcerr bcerrors.BCError) {
