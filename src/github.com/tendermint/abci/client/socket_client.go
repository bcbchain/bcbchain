...
func (cli *socketClient) QueryExAsync(req types.RequestQueryEx) *ReqRes {
	return cli.queueRequest(types.ToRequestQueryEx(req))
}
...
func (cli *socketClient) CleanDataAsync() *ReqRes {
	return cli.queueRequest(types.ToRequestCleanData())
}
...
func (cli *socketClient) QueryExSync(req types.RequestQueryEx) (*types.ResponseQueryEx, error) {
	reqres := cli.queueRequest(types.ToRequestQueryEx(req))
	cli.FlushSync()
...
func (cli *socketClient) CleanDataSync() (*types.ResponseCleanData, error) {
	reqres := cli.queueRequest(types.ToRequestCleanData())
	cli.FlushSync()
...
func resMatchesReq(req *types.Request, res *types.Response) (ok bool) {
	...
	case *types.Request_QueryEx:
		_, ok = res.Value.(*types.Response_QueryEx)
	...
	case *types.Request_CleanData:
		_, ok = res.Value.(*types.Response_CleanData)
	}
	return ok
}
