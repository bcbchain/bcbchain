...
func (m *Request) GetQueryEx() *RequestQueryEx {
	if x, ok := m.GetValue().(*Request_QueryEx); ok {
		return x.QueryEx
	}
	return nil
}
...
func (m *Request) GetCleanData() *RequestCleanData {
	if x, ok := m.GetValue().(*Request_CleanData); ok {
		return x.ClenaData
	}
	return nil
}
...
func _Request_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Request_QueryEx:
		_ = b.EncodeVarint(14<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.QueryEx); err != nil {
			return err
		}
	...
	case *Request_CleanData:
		_ = b.EncodeVarint(13<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ClenaData); err != nil {
			return err
		}
	case nil:
	default:
...
func _Request_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 7: // value.query
		...
		return true, err
	case 14: // value.queryEx
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RequestQueryEx)
		err := b.DecodeMessage(msg)
		m.Value = &Request_QueryEx{msg}
		return true, err
	...
	case 12: // value.commit
		...
		return true, err
	case 13: // value.commit
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RequestCleanData)
		err := b.DecodeMessage(msg)
		m.Value = &Request_CleanData{msg}
		return true, err
	default:
		return false, nil
	}
...
func (m *RequestQueryEx) Reset()                    { *m = RequestQueryEx{} }
func (m *RequestQueryEx) String() string            { return proto.CompactTextString(m) }
func (*RequestQueryEx) ProtoMessage()               {}
func (*RequestQueryEx) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{34} }
...
func (m *RequestCleanData) Reset()                    { *m = RequestCleanData{} }
func (m *RequestCleanData) String() string            { return proto.CompactTextString(m) }
func (*RequestCleanData) ProtoMessage()               {}
func (*RequestCleanData) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{11} }
...
func (m *Response) GetQueryEx() *ResponseQueryEx {
	if x, ok := m.GetValue().(*Response_QueryEx); ok {
		return x.QueryEx
	}
	return nil
}
...
func (m *Response) GetCleanData() *ResponseCleanData {
	if x, ok := m.GetValue().(*Response_CleanData); ok {
		return x.CleanData
	}
	return nil
}
...
func _Response_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Response_CleanData:
		_ = b.EncodeVarint(13<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.CleanData); err != nil {
			return err
		}
	case nil:
	default:
...
func _Response_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 14: // value.queryEx
		...
		msg := new(ResponseQueryEx)
		err := b.DecodeMessage(msg)
		m.Value = &Response_QueryEx{msg}
		return true, err
	case 8: // value.begin_block
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
	...
	case 12: // value.commit
		...
		return true, err
	case 13: // value.clean_data
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ResponseCleanData)
		err := b.DecodeMessage(msg)
		m.Value = &Response_CleanData{msg}
		return true, err
	default:
		return false, nil
	}
...
func (m *ResponseQueryEx) Reset()                    { *m = ResponseQueryEx{} }
func (m *ResponseQueryEx) String() string            { return proto.CompactTextString(m) }
func (*ResponseQueryEx) ProtoMessage()               {}
func (*ResponseQueryEx) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{35} }
...
/*func (m *ResponseQueryEx) GetKey() []byte {
	if m != nil {
		return m.Key
	}
	return nil
...
func (m *ResponseQueryEx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *ResponseCleanData) Reset()                    { *m = ResponseCleanData{} }
func (m *ResponseCleanData) String() string            { return proto.CompactTextString(m) }
func (*ResponseCleanData) ProtoMessage()               {}
func (*ResponseCleanData) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{36} }
...
func (m *SideChainGenesis) Reset()                    { *m = SideChainGenesis{} }
func (m *SideChainGenesis) String() string            { return proto.CompactTextString(m) }
func (*SideChainGenesis) ProtoMessage()               {}
func (*SideChainGenesis) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{34} }
...
func (*ContractData) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{35} }
...
func init() {
	...
	proto.RegisterType((*RequestQueryEx)(nil), "types.RequestQueryEx")
	...
	proto.RegisterType((*RequestCleanData)(nil), "types.RequestCleanData")
	...
	proto.RegisterType((*ResponseQueryEx)(nil), "types.ResponseQueryEx")
...
func (c *aBCIApplicationClient) QueryEx(ctx context.Context, in *RequestQueryEx, opts ...grpc.CallOption) (*ResponseQueryEx, error) {
	out := new(ResponseQueryEx)
	err := grpc.Invoke(ctx, "/types.ABCIApplication/QueryEx", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIApplicationClient) CleanData(ctx context.Context, in *RequestCleanData, opts ...grpc.CallOption) (*ResponseCleanData, error) {
	out := new(ResponseCleanData)
	err := grpc.Invoke(ctx, "/types.ABCIApplication/CleanData", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ABCIApplicationServer interface {
	...
	CleanData(context.Context, *RequestCleanData) (*ResponseCleanData, error)
}
...
func _ABCIApplication_QueryEx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestQueryEx)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIApplicationServer).QueryEx(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/types.ABCIApplication/QueryEx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIApplicationServer).QueryEx(ctx, req.(*RequestQueryEx))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ABCIApplication_CleanData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestCleanData)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIApplicationServer).CleanData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/types.ABCIApplication/CleanData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIApplicationServer).CleanData(ctx, req.(*RequestCleanData))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ABCIApplication_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "QueryEx",
			Handler:    _ABCIApplication_QueryEx_Handler,
		},
		{
			MethodName: "Commit",
		...
		},
		{
			...
			Handler:    _ABCIApplication_CleanData_Handler,
		},
	},
