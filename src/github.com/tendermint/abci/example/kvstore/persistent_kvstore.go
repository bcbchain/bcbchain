...
func (app *PersistentKVStoreApplication) QueryEx(reqQuery types.RequestQueryEx) types.ResponseQueryEx {
	return app.app.QueryEx(reqQuery)
}
...
func (app *PersistentKVStoreApplication) CleanData() types.ResponseCleanData {
	return types.ResponseCleanData{}
}
